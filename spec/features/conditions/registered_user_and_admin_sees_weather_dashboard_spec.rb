...
describe "As a registered user and admin" do
  describe "when I visit the weather-dashboard" do
    ...
    it "shows weather analytics" do
      ...
      expect(page).to have_content(Condition.avg_trips_precipitation(0.5..1.0))
      expect(page).to have_content(Condition.extremum_trips_precipitation(0.5..1.0, 'DESC'))
      expect(page).to have_content(Condition.extremum_trips_precipitation(0.5..1.0, 'ASC'))
      expect(page).to have_content(Condition.avg_trips_precipitation(1.0..1.5))
      expect(page).to have_content(Condition.extremum_trips_precipitation(1.0..1.5, 'DESC'))
      expect(page).to have_content(Condition.extremum_trips_precipitation(1.0..1.5, 'ASC'))
      ...
      expect(page).to have_content(Condition.avg_trips_visibility(4..8))
      expect(page).to have_content(Condition.extremum_trips_visibility(4..8, 'DESC'))
      expect(page).to have_content(Condition.extremum_trips_visibility(4..8, 'ASC'))
