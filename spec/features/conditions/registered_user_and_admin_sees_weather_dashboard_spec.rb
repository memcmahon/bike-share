...
describe "As a registered user and admin" do
  describe "when I visit the weather-dashboard" do
    ...
    it "shows weather analytics" do
      ...
      expect(page).to have_content(Condition.extremum_trips_max_temp('max', 50..60))
      expect(page).to have_content(Condition.extremum_trips_max_temp('min', 50..60))
      expect(page).to have_content(Condition.avg_trips_max_temp(61..70))
      expect(page).to have_content(Condition.extremum_trips_max_temp('max', 61..70))
      expect(page).to have_content(Condition.extremum_trips_max_temp('min', 61..70))
      expect(page).to have_content(Condition.avg_trips_max_temp(71..80))
      expect(page).to have_content(Condition.extremum_trips_max_temp('max', 71..80))
      expect(page).to have_content(Condition.extremum_trips_max_temp('min', 71..80))
      expect(page).to have_content(Condition.avg_trips_max_temp(81..90))
      expect(page).to have_content(Condition.extremum_trips_max_temp('max', 81..90))
      expect(page).to have_content(Condition.extremum_trips_max_temp('min', 81..90))
      expect(page).to have_content(Condition.avg_trips_precipitation(0..0.5))
      expect(page).to have_content(Condition.extremum_trips_precipitation('max', 0..0.5))
      expect(page).to have_content(Condition.extremum_trips_precipitation('min', 0..0.5))
      expect(page).to have_content(Condition.avg_trips_precipitation(0.6..1.0))
      expect(page).to have_content(Condition.extremum_trips_precipitation('max', 0.6..1.0))
      expect(page).to have_content(Condition.extremum_trips_precipitation('min', 0.6..1.0))
      expect(page).to have_content(Condition.avg_trips_precipitation(1.1..1.5))
      expect(page).to have_content(Condition.extremum_trips_precipitation('max', 1.1..1.5))
      expect(page).to have_content(Condition.extremum_trips_precipitation('min', 1.1..1.5))
      expect(page).to have_content(Condition.avg_trips_visibility(0..4))
      expect(page).to have_content(Condition.extremum_trips_visibility('max', 0..4))
      expect(page).to have_content(Condition.extremum_trips_visibility('min', 0..4))
      expect(page).to have_content(Condition.avg_trips_visibility(5..8))
      expect(page).to have_content(Condition.extremum_trips_visibility('max', 5..8))
      expect(page).to have_content(Condition.extremum_trips_visibility('min', 5..8))
      expect(page).to have_content(Condition.avg_trips_visibility(8..12))
      expect(page).to have_content(Condition.extremum_trips_visibility('max', 8..12))
      expect(page).to have_content(Condition.extremum_trips_visibility('min', 8..12))
      expect(page).to have_content(Condition.avg_trips_wind_speed(0..4))
      expect(page).to have_content(Condition.extremum_trips_wind_speed('max', 0..4))
      expect(page).to have_content(Condition.extremum_trips_wind_speed('min', 0..4))
      expect(page).to have_content(Condition.avg_trips_wind_speed(5..9))
      expect(page).to have_content(Condition.extremum_trips_wind_speed('max', 5..9))
      expect(page).to have_content(Condition.extremum_trips_wind_speed('min', 5..9))
      expect(page).to have_content(Condition.avg_trips_wind_speed(10..14))
      expect(page).to have_content(Condition.extremum_trips_wind_speed('max', 10..14))
      expect(page).to have_content(Condition.extremum_trips_wind_speed('min', 10..14))
      expect(page).to have_content(Condition.avg_trips_wind_speed(15..19))
      expect(page).to have_content(Condition.extremum_trips_wind_speed('max', 15..19))
      expect(page).to have_content(Condition.extremum_trips_wind_speed('min', 15..19))
      expect(page).to have_content(Condition.avg_trips_wind_speed(20..24))
      expect(page).to have_content(Condition.extremum_trips_wind_speed('max', 20..24))
      expect(page).to have_content(Condition.extremum_trips_wind_speed('min', 20..24))
    end
  end
end
